...
// stating the role of the Seller
if (role === "seller") {
    const sellerInteract = {
        ...commonInteract(role),
        price: toAu(5),
        wisdom: await ask.ask('Enter a wise phrase, Or press Enter for the default: ', (s) => {
    ...
    //connecting the seller's account
